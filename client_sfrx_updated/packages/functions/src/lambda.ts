...
const FRAXTAL_L2_ORACLE = "0xEE095b7d9191603126Da584a1179BB403a027c3A";
const FRAXTAL_L2_PROOVER = "0xabca0b314d15B3e28F24AC0ee84A63001d1b44Db";
...
async function run() {
    ...
    let main_rewardsCycleEnd = await toCheck.rewardsCycleEnd();
    let l2_rewardsCycleEnd = await toPost.rewardsCycleEnd();
    ...
    // console.log(totalAssetStoredL2.toHexString() == "0x"+slot.substring(2).replace(/^0+/, ""));
    // console.log(main_rewardsCycleEnd.toString(), l2_rewardsCycleEnd.toString());
    // console.log(main_rewardsCycleEnd, l2_rewardsCycleEnd)
    if (diff.gt(threshold) || !main_rewardsCycleEnd.toString() == l2_rewardsCycleEnd.toString()) {
